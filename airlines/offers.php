    ...
    <body>
        ...
        <div class='search-airline'>
            <form action='offers.php' method='GET'>
                <input type='text' name='request' placeholder='Place'>
                <input type='submit' value='Send'>
                <a href='offers.php' class='reset-btn'>Reset</a>
            </form>
        </div>
        <?php 
            ...
            if (isset($_REQUEST['request']))
            {
                ...
                $query = "SELECT * FROM offers WHERE name='$request'";
                ...
                while ( $mas = mysql_fetch_array($query_polz)){
                    ...
                    <div class='div_4_pic'>
                        <img height='200px' width='400px' src='{$mas['url_pic']}'>
                    </div>
                    <div class='div_4_h1'>
                        {$mas['name']}
                    </div>
                    ...
                    <div class='div_4_comp'>
                        <span class='comp-icon'><img src='{$mas['url_icon']}' height='60px' width='60px'></span>
                    </div>
                    <div class='div_4_button'>
                        <span class='buy_button'>Buy ({$mas['price']})</span>
                    </div>
                </div>
                    ";
                }
